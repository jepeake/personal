...
***Therefore: as the amount of data increases - it provides a clearer representation of the true world for the model to learn from & therefore the model can encode a more sophisticated model of the world into it’s architecture, & ths has more intelligence. The code & model architecture remain the same - but the encoding of the data into the model defines the capabilities.***